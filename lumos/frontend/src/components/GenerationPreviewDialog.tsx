...
const GenerationPreviewDialog: React.FC<GenerationPreviewDialogProps> = ({
  ...
  const handleAddCapability = () => {
    if (
      newCapability.trim() &&
      !editedData.capabilities.includes(newCapability.trim())
    ) {
      setEditedData({
        ...editedData,
    ...
    >
      <DialogTitle sx={{ display: "flex", alignItems: "center", gap: 1 }}>
        ...
        <Typography variant="h6">
          Review Generated {type === "agent" ? "Agent" : "Tool"}
        </Typography>
      </DialogTitle>
      ...
      <DialogContent>
        <Box sx={{ mt: 2, mb: 3 }}>
          <Typography variant="body2" color="text.secondary" gutterBottom>
            Review and edit the {type === "agent" ? "agent" : "tool"} details
              ...
              <Grid item component="div" xs={12}>
                ...
                <Box sx={{ display: "flex", mb: 2 }}>
                  <TextField
                    ...
                    onKeyPress={(e) =>
                      e.key === "Enter" && handleAddCapability()
                    }
                  />
                  <Button
                    variant="outlined"
